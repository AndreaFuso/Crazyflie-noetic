...
from CrazyflieBeta.msg import CustomTrajectoryPointYaw_msg
from CrazyflieBeta.srv import CustomTrajectoryPointYaw_srv, CustomTrajectoryPointYaw_srvRequest
