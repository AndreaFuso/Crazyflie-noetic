...
# if only turn left, there will be some points we cant detect, so we do another turn right to totally percept the environment
import rospy
...
class FollowWall():
    def __init__(self):
        ...
        # Service servers
        rospy.Service('wall_follower_turn_right_switch', SetBool, self.wall_follower_turn_right_switch)
        rospy.loginfo("Wall_follower_turn_right server is ready")
    ...
    def wall_follower_turn_right_switch(self, req):
...
if __name__ == '__main__':
    rospy.init_node("follow_wall_turn_right_server")
    my_node = FollowWall()
