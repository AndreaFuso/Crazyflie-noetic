...
class MappingBug1():
    def __init__(self):
        ...
        rospy.Subscriber('/cf1/state',CrazyflieState,self.clbk_odom)
    ...
    def clbk_odom(self,msg):
        ...
        self.odom_position_ = msg.position

        # Get ground yaw
        self.odom_yaw_ = msg.orientation.yaw
    ...
    def take_action_mapping_bug1(self):
        while not rospy.is_shutdown():
            ...
            if self.state_ == 0:
                ...
                if self.count_state_time_ > 200 and \
