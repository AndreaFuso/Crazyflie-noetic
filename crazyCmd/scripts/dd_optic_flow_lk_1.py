...
class OpticFlowCalculator():
    def __init__(self):
        ...
        self.optic_flow_pub_vel_x = rospy.Publisher("optic_flow_vel_x", Float32, queue_size=10)
        self.optic_flow_pub_vel_y = rospy.Publisher("optic_flow_vel_y", Float32, queue_size=10)

        # Publish the relative movement in real world
        self.optic_flow_pub_delta_x = rospy.Publisher("optic_flow_delta_x", Float32, queue_size=10)
        self.optic_flow_pub_delta_y = rospy.Publisher("optic_flow_delta_y", Float32, queue_size=10)
    ...
    def image_callback(self, image):
        try: 
            ...
            vel_y = h*theta_px*delta_px_mean/(dt*Ny)-h*pitch_rate
            ...
            self.delta_x += vel_x*dt
            self.delta_y += vel_y*dt
