...
if __name__ == '__main__':
    ...
    # Extracting rosparam informations (to understand the name and 
    # spawn position):
    crazyflie_name = rospy.get_param('crazyflie_spawner_node/name')
    initial_pos = rospy.get_param(
        'crazyflie_spawner_node/initial_position')

    # Spawning the virtual Crazyflie:
    CrazySim(crazyflie_name, Vector3(initial_pos[0], initial_pos[1],
                                     initial_pos[2]))
